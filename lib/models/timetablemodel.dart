...
class Timetable {
    ...
    factory Timetable.fromJson(Map<String, dynamic> json) => Timetable(
        ...
        timetableOperationStart: DateTime.parse(json["timetableOperationStart"]),
        timetableOperationEnd: DateTime.parse(json["timetableOperationEnd"]),
        timetablesByDay: List<TimetablesByDay>.from(json["timetablesByDay"].map((x) => TimetablesByDay.fromJson(x))),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "timetablesByDay": List<dynamic>.from(timetablesByDay.map((x) => x.toJson())),
    };
}

enum TimetableType { WINTER }

final timetableTypeValues = EnumValues({
    "winter": TimetableType.WINTER
});
...
class TimetablesByDay {
    ...
    factory TimetablesByDay.fromJson(Map<String, dynamic> json) => TimetablesByDay(
